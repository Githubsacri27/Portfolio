...
<div class="content-wrapper">
  ...
  <section class="content">
    <div class="container-fluid">
      ...
      @include('_message')
      <a href="{{url ('admin/works/add')}}" class="btn btn-primary">Add Works</a>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <img src="{{ url('public/works/'.$value->image) }}" style="width: 80px; height: 80px; border-radius: 50%;">
                      @endif
                    ...
                    <td>
                      <a href="{{ url('admin/works/edit/'.$value->id)}}" class="btn btn-primary">Edit</a>
