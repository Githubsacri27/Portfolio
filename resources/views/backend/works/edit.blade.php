...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Edit Works Page</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    ...
                    <div class="card card-info">
                        ...
                        <form class="form-horizontal" method="post" action="{{url('admin/works/edit/'.$getrecord->id)}}" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Works Title <span
                                 style="color: red;"> *</span></label>                                   
                                    <div class="col-sm-10">
                                        <input type="text" name="title" class="form-control"
                                         placeholder="Works Title" value="{{$getrecord->title}}" required>

                                    </div>
                                </div>

                                <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Url <span
                                 style="color: red;"> *</span></label>                                   
                                    <div class="col-sm-10">
                                        <input type="text" name="url" class="form-control"
                                         placeholder="Url" value="{{$getrecord->url}}" required>
                                ...
                                <label class="col-sm-2 col-form-label">Works Description
                                    ...
                                    <div class="col-sm-10">
                                        <textarea type="text" name="description" class="form-control" placeholder="Works Description" value="{{$getrecord->description}}"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">Text Editor
                                        <span style="color: red;"> *</span></label>
                                    <div class="col-sm-10">
                                        <textarea type="text" name="text_editor" class="form-control editor" placeholder="Text Editor" value="{{$getrecord->text_editor}}"></textarea>
                                    </div>
                                </div>
